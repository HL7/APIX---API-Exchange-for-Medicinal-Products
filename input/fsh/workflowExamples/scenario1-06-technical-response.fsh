...
<div style=\"background:#ffffff;border:1px solid #ccebd3;border-radius:12px;padding:16px;margin-bottom:12px;box-shadow:0 2px 8px rgba(0,0,0,0.05);\"><div style=\"font-weight:600;color:#34c759;font-size:15px;\">Applicant Responses</div><span style=\"font-family:Menlo,Monaco,Consolas,monospace;background:#e6f9eb;padding:2px 8px;border-radius:6px;font-size:13px;\">regulatory-document</span><br />response-to-questions.pdf</div>

<div style=\"background:#ffffff;border:1px solid #ccebd3;border-radius:12px;padding:16px;margin-bottom:12px;box-shadow:0 2px 8px rgba(0,0,0,0.05);\"><div style=\"font-weight:600;color:#34c759;font-size:15px;\">Annex: Raw Stability Data</div><span style=\"font-family:Menlo,Monaco,Consolas,monospace;background:#e6f9eb;padding:2px 8px;border-radius:6px;font-size:13px;\">regulatory-document</span><br />raw-stability-data.json</div></div></div>
