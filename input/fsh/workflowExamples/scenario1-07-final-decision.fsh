...
<div style=\"font-size:24px;font-weight:600;color:#007aff;margin:0 0 24px 0;padding-bottom:12px;border-bottom:1px solid #e5e5ea;display:flex;justify-content:space-between;align-items:center;\">Output Documents<span style=\"background:#34c759;color:#ffffff;font-size:14px;font-weight:600;padding:6px 14px;border-radius:20px;\">4 documents</span></div><div style=\"margin:24px 0;padding:20px;background:#f2fff5;border-radius:14px;border-left:5px solid #34c759;\"><div style=\"margin:0 0 16px 0;font-size:18px;color:#34c759;font-weight:600;\">Regulator Output</div><div style=\"background:#ffffff;border:1px solid #ccebd3;border-radius:12px;padding:16px;margin-bottom:12px;box-shadow:0 2px 8px rgba(0,0,0,0.05);\"><div style=\"font-weight:600;color:#34c759;font-size:15px;\">Acknowledgement of Receipt</div><span style=\"font-family:Menlo,Monaco,Consolas,monospace;background:#e6f9eb;padding:2px 8px;border-radius:6px;font-size:13px;\">acknowledgement-receipt</span><br />Acknowledgement_Letter.pdf</div><div style=\"background:#ffffff;border:1px solid #ccebd3;border-radius:12px;padding:16px;margin-bottom:12px;box-shadow:0 2px 8px rgba(0,0,0,0.05);\"><div style=\"font-weight:600;color:#34c759;font-size:15px;\">Validation Report</div><span style=\"font-family:Menlo,Monaco,Consolas,monospace;background:#e6f9eb;padding:2px 8px;border-radius:6px;font-size:13px;\">validation-report</span><br />Validation_Report.pdf</div>

<div style=\"background:#ffffff;border:1px solid #d1e4ff;border-radius:12px;padding:16px;margin-bottom:12px;box-shadow:0 2px 8px rgba(0,0,0,0.05);\"><div style=\"font-weight:600;color:#34c759;font-size:15px;\">Approval Letter</div><span style=\"font-family:Menlo,Monaco,Consolas,monospace;background:#e6f9eb;padding:2px 8px;border-radius:6px;font-size:13px;\">regulatory-document</span><br />approval-letter.pdf</div><div style=\"background:#ffffff;border:1px solid #d1e4ff;border-radius:12px;padding:16px;margin-bottom:12px;box-shadow:0 2px 8px rgba(0,0,0,0.05);\"><div style=\"font-weight:600;color:#34c759;font-size:15px;\">Final Assessment Report</div><span style=\"font-family:Menlo,Monaco,Consolas,monospace;background:#e6f9eb;padding:2px 8px;border-radius:6px;font-size:13px;\">regulatory-document</span><br />final-assessment-report.pdf</div>
